...
function App() {
  ...
  <div className="flex items-center gap-2">
    <img src={logo} alt="company logo" className="h-15 w-auto object-contain" />
  </div>
  ...
  {/* Left content */}
  <div className="w-1/2">
    <h1 className="text-5xl font-bold text-blue-600 mt-30">Advanced Payment Solutions</h1>
    <h1 className="text-5xl font-bold ">for India's boldest Disrupters</h1>
    <p>100+ Payment Methods | Easy Integration | Powerful Dashboard</p>
    <button class="inline-flex items-center px-4 py-3 bg-blue-600 text-white rounded hover:bg-blue-700 transition mt-5">
      <span>Sign Up Now  </span>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" className='ml-2 size-5'><path d="M566.6 342.6C579.1 330.1 579.1 309.8 566.6 297.3L406.6 137.3C394.1 124.8 373.8 124.8 361.3 137.3C348.8 149.8 348.8 170.1 361.3 182.6L466.7 288L96 288C78.3 288 64 302.3 64 320C64 337.7 78.3 352 96 352L466.7 352L361.3 457.4C348.8 469.9 348.8 490.2 361.3 502.7C373.8 515.2 394.1 515.2 406.6 502.7L566.6 342.7z"/></svg>
      </button>
  </div>
